...
public final class Flags {
	...
	public final static SetFlag<String> COMMAND_ON_ENTRY = new CustomSetFlag("command-on-entry",
			new CommandStringCaseSensitiveFlag(null));
	public final static SetFlag<String> COMMAND_ON_EXIT = new CustomSetFlag("command-on-exit",
			new CommandStringCaseSensitiveFlag(null));

	public final static SetFlag<String> CONSOLE_COMMAND_ON_ENTRY = new CustomSetFlag("console-command-on-entry",
			new CommandStringCaseSensitiveFlag(null));
	public final static SetFlag<String> CONSOLE_COMMAND_ON_EXIT = new CustomSetFlag("console-command-on-exit",
			new CommandStringCaseSensitiveFlag(null));
	...
	public final static SetFlag<PotionEffectType> BLOCKED_EFFECTS = new SetFlag("blocked-effects",
			new PotionEffectTypeFlag(null));
